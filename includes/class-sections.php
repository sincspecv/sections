...
class Sections {
	 ...
	 * @since    0.1.0
	 * @access   protected
	 * @var      Sections_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'TFR_SECTIONS_VERSION' ) ) {
			$this->version = TFR_SECTIONS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - Sections_Loader. Orchestrates the hooks of the plugin.
	 * - Sections_i18n. Defines internationalization functionality.
	 * - Sections_Admin. Defines all hooks for the admin area.
	 * - Sections_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-sections-loader.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-sections-public.php';

		$this->loader = new Sections_Loader();
	 ...
	 *
	 * Uses the Sections_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    0.1.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Sections_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Sections_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     0.1.0
	 * @return    Sections_Loader    Orchestrates the hooks of the plugin.
	 */
